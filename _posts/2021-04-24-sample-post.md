...
description: A sample post to show how the content will look and how will different headlines, quotes and codes will be represented.
tags:
- sample
- post
- test
...
![Test Image](/WhatATheme/assets/images/sites/placeholder.png) -->

**Some colors can be used for latex equation:**


![Latex color](/assets/images/blogs/diffusion_summary/latex_color.jpg) 
